...
El build genera los assets en `static/home/`. FastAPI sirve este build en `/` y conserva el Home anterior en `static/index_legacy.html` para los formularios existentes.
