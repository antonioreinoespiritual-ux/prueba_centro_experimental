...
from .routers import experiments, records, documentation, ai_analysis, publics, assistant, files, cloud, drive_sync, hypotheses_ui, interviews, interviews_ui, clients, campaigns
ensure_schema()
